...
const controlSearchResults = async function() {
    try {
        // 1 get search query
        const query = (0, _searchViewJsDefault.default).getQuerry();
        if (!query) return;
        ...
        (0, _resultsViewJsDefault.default)._errorMessage();
    }
};
...
const controlAddBookmark = function() {
    ...
    else if (_modelJs.state.recipe.bookmarked) _modelJs.deleteBookmark(_modelJs.state.recipe);
    // 2) update recipeView
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
    // 3)render bookmark
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        //Close form Windown
        setTimeout(function() {
            (0, _addRecipeViewJsDefault.default).toggleWindow(); //need a fix. User can close the windown before the timer elapced
...
},{"regenerator-runtime":"dXNgZ","regenerator-runtime/runtime":"dXNgZ","./config":"k5Hzs","./helpers":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
const API_KEY = "f88011af-0c4b-4cda-84b5-826a2f801ddb";
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    <li class="recipe__ingredient">
          ...
          <div class="recipe__quantity">${ingredient.quantity ? (0, _helpers.numberToFraction)(ingredient.quantity) : ""}</div>
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","../helpers":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (currPage === 1 && numPages > 1) return this._generateMarkupButton(currPage, "right");
        //last page
        if (currPage === numPages && numPages > 1) return this._generateMarkupButton(currPage, "left");
        // Other page
    ...
    _generateMarkupButton(currPage, direction) {
        ...
        return `
    <button data-goto='${goto}'class="btn--inline pagination__btn--${direction === "left" ? "prev" : "next"}">
        <svg class="search__icon">
...
},{"./View":"5cUXS","url:../../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fA0o9","aenu9"], "aenu9", "parcelRequire7e89")
